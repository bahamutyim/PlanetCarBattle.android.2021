...
namespace com.ahyim.planet
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private CarUserControl rootUserControl;

        private void Start()
        {
            rootUserControl = transform.root.GetComponent<CarUserControl>();
        }
        ...
        private CarControl m_CarController; // Reference to car we are controlling

        private AudioMixer gameAudioMixer;
        private AudioMixerGroup gameAudioMixerGroup;

        private void StartSound()
        {
            gameAudioMixer = Resources.Load<AudioMixer>("GameAudioMixer");
            gameAudioMixerGroup = gameAudioMixer.FindMatchingGroups("Master/Enigne")[0];
        ...
        private void Update()
        {
            if (rootUserControl && rootUserControl.isLocalPlayer)
            {
        ...
        private AudioSource SetUpEngineAudioSource(AudioClip clip)
        {
            ...
            source.outputAudioMixerGroup = gameAudioMixerGroup;
            return source;
        }
