...
namespace emotitron.Network.NST
{
	...
	public class NSTMapBounds : MonoBehaviour
	{
		...
		public static Bounds fallBackBounds = new Bounds(new Vector3(0 , 0, 0), new Vector3(2000, 2000, 2000));
		// All bounds accounted for (in case there are more than one active Bounds objects
		public static Bounds combinedBounds = new Bounds(new Vector3(0, 0, 0), new Vector3(2000, 2000, 2000));
		...
		{
            //override the auto detecting  bounds setting
            combinedBounds = fallBackBounds;
