...
namespace emotitron.Network.NST
{
	...
	public static class NSTCompressVector
	{
        ...
        //For extend the axis range 
        public static float boundBuffer = 10;
		...
		private static void EstablishMinBitsPerAxis()
		{
			...
			{
				AxisRanges(axis).ChangeRange(NSTMapBounds.combinedBounds.min[axis] - boundBuffer, NSTMapBounds.combinedBounds.max[axis] + boundBuffer, NSTSettings.single.minPosResolution);
                Debug.LogFormat("axis:{0},min:{1},max{2},posResolution:{3}", axis, NSTMapBounds.combinedBounds.min[axis], NSTMapBounds.combinedBounds.max[axis], NSTSettings.single.minPosResolution);
